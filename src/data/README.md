...
- `mockApi.ts` — Consulta simulada en memoria por placa/DNI/expediente. `consultarDemo` añade un resultado sintético determinista para datos no encontrados (demo de exposición). Exports: `consultarSAT`, `consultarDemo`, `MockResultData`, `MockApiResponse`.
